...
def find_tirex_tracker_executable_or_none():
    # wget https://github.com/tira-io/tirex-tracker/releases/download/0.2.18/measure-0.2.18-linux -O 'tirex-tracker-0.2.18-linux'
    # chmod +x tirex-tracker-0.2.18-linux
    ret = Path(__file__).parent / "tirex-tracker-0.2.18-linux"
