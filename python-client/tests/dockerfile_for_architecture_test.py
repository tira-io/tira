...
class TestDockerfileForArchitecture(unittest.TestCase):
    ...
    def test_x86_64_returns_dockerfile(self, mock_exists, mock_machine):
        ...
        self.assertEqual(result, 'Dockerfile.amd64')

    @patch('platform.machine')
    @patch('os.path.exists', return_value=True) 
    def test_arm64_returns_dockerfile_arm64(self,mock_exists, mock_machine):
    ...
    @patch('platform.machine')
    @patch('os.path.exists', return_value=True) 
    def test_arm64_variant_aarch(self, mock_exists, mock_machine):
    ...
    @patch('platform.machine')
    def test_unknown_arch(self, mock_machine):
