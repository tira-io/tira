...
from tira.third_party_integrations import (
    ...
    load_ir_datasets,
    register_rerank_data_to_ir_datasets,
)
...
class TestIRDatasets(unittest.TestCase):
    ...
    def test_loading_docs_via_rest_api_from_tira_01(self):
        ...
        assert docsstore.get("2005.ipm_journal-ir0anthology0volumeA41A1.7").text.startswith(
            "A probabilistic model for stemmer generation AbstractIn this paper"
        )
    ...
    def test_loading_dataset_from_remote_zip_01(self):
        zip_file = "https://github.com/tira-io/tira/raw/refs/heads/main/python-client/tests/resources/example-dataset.zip"
