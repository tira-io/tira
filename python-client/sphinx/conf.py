...
html_theme_options: Dict[str, Any] = {
    ...
    "announcement": '<a href="/unlisted/maintenance.html">Due to planned maintenance starting on March 25, TIRA is currently down.</a><br>While you wait until the March 28 for us to be back, you may read our documentation. GLHF',
}
