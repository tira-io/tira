...
.. grid:: 1 2 3 3
   ...
   .. grid-item-card:: :octicon:`sync` Reproducible
    
      Via containerization, we don't only store the code that produced the submission but also the environment it ran in.
...
.. grid:: 1 1 1 1
   ...
   .. grid-item-card:: :octicon:`home-fill` Organize a Shared Task
      ...
      For those who have train-, test-, and validation-data and want to see how they can be fitted well.
...
.. note:: You just want to try TIRA within your organization without setting up the production deployment? We have created a slimmed down demo deployment just for this!
