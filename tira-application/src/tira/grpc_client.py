...
class GrpcClient:
    ...
    def run_execute(self, submissionFile, inputDatasetName, inputRunPath, outputDirName, sandboxed, optionalParameters):
        response = self.stub.run_execute(tira_host_pb2.RequestRunExecuteEval(submissionFile=submissionFile,
                                                                             inputDatasetName=inputDatasetName,
                                                                             inputRunPath=inputRunPath,
    ...
    def run_eval(self, vm_name, submissionFile, inputDatasetName, inputRunPath, outputDirName, sandboxed,
                 optionalParameters):
        response = self.stub.run_eval(tira_host_pb2.RequestRunExecuteEval(submissionFile=submissionFile,
                                                                          inputDatasetName=inputDatasetName,
                                                                          inputRunPath=inputRunPath,
                                                                          outputDirName=outputDirName,
                                                                          sandboxed=sandboxed,
