...
urlpatterns = [
    ...
    path('data_api/evaluations/<str:task_id>/<str:dataset_id>', data_api.get_evaluations_by_dataset, name='get_evaluations_by_dataset'),
    path('data_api/runs/<str:task_id>/<str:dataset_id>', data_api.get_runs_by_dataset, name='get_runs_by_dataset')
]
app_name = 'tira'
