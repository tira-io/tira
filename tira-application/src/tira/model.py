...
class Task(models.Model):
    ...
    task_description = models.CharField(max_length=280, default="")
    ...
    command_placeholder = models.CharField(max_length=280, default="mySoftware -c $inputDataset -r $inputRun -o $outputDir")
    command_description = models.CharField(max_length=280, default="Available variables: <code>$inputDataset</code>, <code>$inputRun</code>, <code>$outputDir</code>, <code>$dataServer</code>, and <code>$token</code>.")
...
class Software(models.Model):
    ...
    working_directory = models.CharField(max_length=150)
