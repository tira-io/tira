...
class TestRenderingOfJobFile(TestCase):
    ...
    def test_rendering_with_multiple_input_runs_and_hf_mounts_and_tira_image_workdir(self):
        ...
        args = {
            ...
            "input_run": input_run,
            "mount_hf_model": "a b c",
            "tira_image_workdir": "/tmp/a-b-c-d",
        }
    ...
    def verify_metadata(args, test_name):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            git_runner.write_metadata_for_ci_job_to_repository(
                ...
                args.get("transaction_id", "transaction_id"),
                args.get("dataset_id", "dataset_id"),
                args.get("vm_id", "vm_id"),
                args.get("run_id", "run_id"),
                args.get("identifier", "identifier"),
                args.get("git_runner_image", "Some image for the git runner"),
                args.get("git_runner_command", "command in the git runner"),
                args.get("evaluator_id", "evaluator_id"),
                ...
                args["tira_software_id"],
                args["resources"],
                args["input_run"],
                args.get("mount_hf_model", None),
