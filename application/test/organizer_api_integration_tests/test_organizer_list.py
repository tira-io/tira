...
class TestOrganizerList(TestCase):
    ...
    def test_api_organizer_list_is_empty_for_non_existing_organizer(self):
        ...
        # Assert
        self.verify_as_json(
            actual, "organizer_api_integration_tests/test_api_organizer_list_is_empty_for_non_existing_organizer.json"
        )
    ...
    def test_api_organizer_list_is_non_empty_for_existing_organizer(self):
        ...
        # Assert
        self.verify_as_json(
            actual, "organizer_api_integration_tests/test_api_organizer_list_is_non_empty_for_existing_organizer.json"
        )
    ...
    def test_api_organizer_list_is_complete_for_admin(self):
        ...
        # Assert
        self.verify_as_json(
            actual, "organizer_api_integration_tests/test_api_organizer_list_is_complete_for_admin.json"
        )
