...
def add_TiraHostServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("tira.generated.TiraHostService", rpc_method_handlers)
...
def add_TiraApplicationServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("tira.generated.TiraApplicationService", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
