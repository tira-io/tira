...
export default {
  ...
  computed: {
    ...
    fields_to_skip() {
      let ret = ['vm_id', 'input_software_name', 'published', 'blinded', 'link_to_team', 'link_results_download', 'link_run_download', 'link_serp', 'is_upload', 'is_software', 'dataset_id', 'selectable']
