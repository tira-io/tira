<template>
  ...
  <v-stepper :items="['Local Tests of your Docker Submission', 'Add the Docker Submission', 'Final Checks']">
  <template v-slot:item.1 style="min-height: 100vh">
...
cat tira-evaluation/evaluation.prototext" expand_message="(3) Verify the evaluator outputs to ensure all outputs are valid"/>
  ...
  <template v-slot:item.2 style="min-height: 100vh">
...
<v-text-field v-model="runCommand" clearable
  ...
  <template v-slot:item.3 style="min-height: 100vh">
