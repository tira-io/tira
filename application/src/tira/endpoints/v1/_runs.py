...
class _ReviewSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["run_id", "reviewer_id", "review_date", "no_errors", "missing_output", "extraneous_output", "invalid_output", "has_error_output", "other_errors", "comment", "has_errors", "has_warnings", "has_no_errors", "published", "blinded"]
