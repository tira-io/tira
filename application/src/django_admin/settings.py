...
GIT_CI_AVAILABLE_RESOURCES = {
    ...
    'a100-resources-gpu': {'cores': 5, 'ram': 50, 'gpu': '1-nvidia-a100', 'data': 'no', 'description': 'XL w. GPU (7 CPU Cores, 79GB of RAM, 1 Nvidia GTX 1080 with 4GB)', 'key': 'a100-resources-gpu'}
}
